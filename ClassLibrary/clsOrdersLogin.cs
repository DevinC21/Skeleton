...
namespace ClassLibrary
{
    public class clsOrdersLogin
    {
        ...
        public bool FindOrders(string LoginName, string LoginPassword)
        {
            //create an instance of the data connection
            clsDataConnection DB = new clsDataConnection();
            //add the parameters for the user login name and login password to search for
