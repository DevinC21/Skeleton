...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblDob" runat="server" style="z-index: 1; left: 10px; top: 120px; position: absolute" Text="Date of Birth" width="102px"></asp:Label>
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 65px; top: 270px; position: absolute" Text="Cancel" />
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 10px; top: 270px; position: absolute; right: 522px" Text="OK" />
    </form>
</body>
</html>
