...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="BtnMainMenu" runat="server" style="z-index: 1; left: 189px; top: 271px; position: absolute; width: 163px;" Text="Return to Main Menu" OnClick="btnMainMenu_Click" />
    </form>
</body>
</html>